...
public class Program {
	...
	public static void main(String[] args) {
		try {
			...
			// Connection est l'interface décrivant un objet permettant de se connecter a une base de donnée
			// le DriverManager renvoie un objet implémentant cette interface qui est capable de gérer l'url qu'on lui a fournie
