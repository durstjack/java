package com.loncoto.webapps.StrutsFormationDatabase2.utils;
...
public class ClientDAO {
	...
	public static final String FIND_BY_ID_SQL = "select * from `clients` where `id`=?";
	public static final String UPDATE_ONE_SQL = "update `clients` set `nom`=?, `email`=?, `solde`=? where `id`=?";
	public static final String INSERT_ONE_SQL = "insert into `clients` (`nom`, `email`, `solde`) values (?,?,?)";
	public static final String DELETE_ONE_SQL = "delete from `clients` where `id`=?";
